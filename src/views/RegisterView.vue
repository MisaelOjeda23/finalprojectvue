                    ...
                    <div class="w-full">
                        ...
                        <form v-on:submit="registrarUsuario" >
                            ...
                            <label class="block text-base">
                                <span class="text-gray-700 dark:text-txt-white-m">Nombre</span>
                                <input
